...
#    descricao = descricao + params[:cardapio] + ", " + params[:acompanhamento] + " Salada: "+ params[:salada]
  ...
  private
    ...
    def pedido_params
      params.require(:pedido).permit(:descricao, :valor, :id, :cliente_id, :cardapio_id, :arroz_id, :salada_id, :forma_de_pagamento, item_de_pedidos_attributes: [ :produto_id, :pedido_id, :quantidade, :_destroy, :id])
    end
end
