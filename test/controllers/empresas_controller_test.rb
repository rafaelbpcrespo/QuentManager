...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { endereco: @empresa.endereco, nome: @empresa.nome, telefone: @empresa.telefone }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { endereco: @empresa.endereco, nome: @empresa.nome, telefone: @empresa.telefone }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
