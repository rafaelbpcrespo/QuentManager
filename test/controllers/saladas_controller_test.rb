...
class SaladasControllerTest < ActionController::TestCase
  ...
  test "should create salada" do
    assert_difference('Salada.count') do
      post :create, salada: { descricao: @salada.descricao, disponibilidade: @salada.disponibilidade, nome: @salada.nome, quantidade: @salada.quantidade, valor: @salada.valor }
    end
  ...
  test "should update salada" do
    patch :update, id: @salada, salada: { descricao: @salada.descricao, disponibilidade: @salada.disponibilidade, nome: @salada.nome, quantidade: @salada.quantidade, valor: @salada.valor }
    assert_redirected_to salada_path(assigns(:salada))
  end
